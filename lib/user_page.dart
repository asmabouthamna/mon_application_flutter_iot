...
class _UserPageState extends State<UserPage> {
  ...
  Future<void> _analyzeWithRaspberry() async {
    ...
    try {
      final response = await http.get(
        Uri.parse('http://172.16.112.89:5000/last_analysis'),
      );
  ...
  Future<void> _predictFile() async {
    ...
    try {
      var request = http.MultipartRequest(
        'POST',
        Uri.parse(
            'http://172.16.112.89:5000/predict_image'), // Utilisez predict_image pour les images
      );
      ...
      if (_selectedFile!.path.endsWith('.mp4')) {
        request = http.MultipartRequest(
          'POST',
          Uri.parse(
              'http://172.16.112.89:5000/predict_video'), // Utilisez predict_video pour les vidéos
        );
      }
  ...
  Future<void> _searchChatById() async {
    ...
    try {
      final response = await http.get(
        Uri.parse('http://172.16.112.89:3090/chats/$chatId'),
      );
